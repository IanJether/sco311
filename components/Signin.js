...
function SigninComp() {
  return (
    <div className='SigninComp bg-teal-500 h-[93vh] relative topmargin'>
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
        ...
        <div className="w-[75%] lg:w-[400px] h-[320px] border border-neutral-500 rr backdrop-blur-[7px] p-[20px]">
          ...
          <div className="flex gap-[10px] items-center">
            ...
            <Link className="w-full" href="/dashboard/products"> <button className="button2 mt-[20px]">Signin</button> </Link>
